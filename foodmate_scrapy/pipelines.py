...
class FoodmateScrapyPipeline(object):
    ...
    def __init__(self):
        ...
        self.jy_file = open('调味品-酱油.csv','a+',encoding='utf-8',newline='')
    ...
    def close_spider(self, spider):
        ...
        self.jy_file.close
        time.sleep(5)
        csvf = pd.read_csv('调味品-酱油.csv', encoding='utf-8')
        if os.path.isfile('调味品-酱油.xlsx') == True:
            os.remove('调味品-酱油.xlsx')
        time.sleep(1)
        csvf.to_excel('调味品-酱油.xlsx', sheet_name='data')